...
def ddd_decode(heat, rots, rotc, hei, dim, dir_preds, vel, direction_offset=0, reg=None, \
              K=100, score_threshold=None, raw_rot=False, voxel_size=None, pc_range =None, feature_map_stride=None):
    ...
    xs = xs.view(batch, K, 1) * feature_map_stride * voxel_size[0] + pc_range[0]
    ys = ys.view(batch, K, 1) * feature_map_stride * voxel_size[1] + pc_range[1]
